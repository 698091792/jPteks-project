    ...
    return (
        <Accordion type="single" collapsible className="  w-full flex flex-col justify-center items-center mx-auto font-serif ">
          ...
          <AccordionItem value="item-1">
            <AccordionTrigger className=" text-md md:text-lg hover:no-underline  ">What is your process for creating a website or an application?</AccordionTrigger>
            <AccordionContent className="text-sm md:text-md hover:no-underline text-justify max-w-md">
          ...
          <AccordionTrigger className=" text-md md:text-lg hover:no-underline  ">How does the discovery phase work?</AccordionTrigger>
            <AccordionContent className="text-sm md:text-md hover:no-underline text-justify max-w-md">
          ...
          <AccordionTrigger className=" text-md md:text-lg hover:no-underline  ">How long does it take to develop a website or an application?</AccordionTrigger>
            <AccordionContent className="text-sm md:text-md hover:no-underline text-justify max-w-md">
          ...
          <AccordionTrigger className=" text-md md:text-lg hover:no-underline  ">How does communication work during the project?</AccordionTrigger>
            <AccordionContent className="text-sm md:text-md hover:no-underline text-justify max-w-md">
          ...
          <AccordionTrigger className=" text-md md:text-lg hover:no-underline  ">What are the payment terms and the cost of a project?</AccordionTrigger>
            <AccordionContent className="text-sm md:text-md hover:no-underline text-justify max-w-md">
          ...
          <AccordionTrigger className=" text-md md:text-lg hover:no-underline  ">How can I request a quote or more information?</AccordionTrigger>
            <AccordionContent className="text-sm md:text-md hover:no-underline text-justify max-w-md">
